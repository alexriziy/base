...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Triangulum.WebsiteBundle.Model.map.AuthorTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Triangulum\\WebsiteBundle\\Model\\Author');
    ...
    {
        $this->addRelation('Book', 'Triangulum\\WebsiteBundle\\Model\\Book', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), null, null, 'Books');
    } // buildRelations()
