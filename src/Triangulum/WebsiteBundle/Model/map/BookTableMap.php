...
class BookTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Triangulum.WebsiteBundle.Model.map.BookTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Triangulum\\WebsiteBundle\\Model\\Book');
    ...
    {
        $this->addRelation('Author', 'Triangulum\\WebsiteBundle\\Model\\Author', RelationMap::MANY_TO_ONE, array('author_id' => 'id', ), null, null);
    } // buildRelations()
