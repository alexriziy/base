...
abstract class BaseGroup extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Triangulum\\WebsiteBundle\\Model\\GroupPeer';
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parentid !== $v) {
            $this->parentid = $v;
            $this->modifiedColumns[] = GroupPeer::PARENTID;
        }
    ...
    public function setRole($v)
    {
        ...
        if ($this->role !== $v) {
            $this->role = $v;
            $this->modifiedColumns[] = GroupPeer::ROLE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GroupPeer::PARENTID)) {
            $modifiedColumns[':p' . $index++]  = '`parentId`';
        }
        if ($this->isColumnModified(GroupPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(GroupPeer::ROLE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GroupPeer::PARENTID)) $criteria->add(GroupPeer::PARENTID, $this->parentid);
        if ($this->isColumnModified(GroupPeer::NAME)) $criteria->add(GroupPeer::NAME, $this->name);
        if ($this->isColumnModified(GroupPeer::ROLE)) $criteria->add(GroupPeer::ROLE, $this->role);
