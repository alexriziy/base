...
abstract class BaseUser extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Triangulum\\WebsiteBundle\\Model\\UserPeer';
    ...
    public function setDateTime($v)
    {
        ...
        if ($this->datetime !== $v) {
            $this->datetime = $v;
            $this->modifiedColumns[] = UserPeer::DATETIME;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->groupid !== $v) {
            $this->groupid = $v;
            $this->modifiedColumns[] = UserPeer::GROUPID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->datetime = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            $this->groupid = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserPeer::DATETIME)) {
        ...
        if ($this->isColumnModified(UserPeer::GROUPID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`datetime`':
                        $stmt->bindValue($identifier, $this->datetime, PDO::PARAM_INT);
                        break;
                    case '`username`':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPeer::DATETIME)) $criteria->add(UserPeer::DATETIME, $this->datetime);
        ...
        if ($this->isColumnModified(UserPeer::GROUPID)) $criteria->add(UserPeer::GROUPID, $this->groupid);
