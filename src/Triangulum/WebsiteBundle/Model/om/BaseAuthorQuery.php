...
use Triangulum\WebsiteBundle\Model\AuthorPeer;
use Triangulum\WebsiteBundle\Model\AuthorQuery;
...
abstract class BaseAuthorQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Triangulum\\WebsiteBundle\\Model\\Author', $modelAlias = null)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Triangulum\WebsiteBundle\Model\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Triangulum\WebsiteBundle\Model\BookQuery');
    }
