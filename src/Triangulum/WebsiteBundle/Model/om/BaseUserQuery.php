 ...
 * @method UserQuery orderByDateTime($order = Criteria::ASC) Order by the datetime column
 ...
 * @method UserQuery orderByGroupId($order = Criteria::ASC) Order by the groupId column
 *
 * @method UserQuery groupById() Group by the id column
 * @method UserQuery groupByDateTime() Group by the datetime column
 ...
 * @method UserQuery groupByGroupId() Group by the groupId column
 *
 ...
 *
 * @method User findOneByDateTime(int $datetime) Return the first User filtered by the datetime column
 ...
 * @method User findOneByGroupId(int $groupId) Return the first User filtered by the groupId column
 *
 * @method array findById(int $id) Return User objects filtered by the id column
 * @method array findByDateTime(int $datetime) Return User objects filtered by the datetime column
 ...
 * @method array findByGroupId(int $groupId) Return User objects filtered by the groupId column
 */
abstract class BaseUserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Triangulum\\WebsiteBundle\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `datetime`, `username`, `password`, `email`, `phone`, `groupId` FROM `user` WHERE `id` = :p0';
        try {
     ...
     * Example usage:
     * <code>
     * $query->filterByDateTime(1234); // WHERE datetime = 1234
     * $query->filterByDateTime(array(12, 34)); // WHERE datetime IN (12, 34)
     * $query->filterByDateTime(array('min' => 12)); // WHERE datetime >= 12
     * $query->filterByDateTime(array('max' => 12)); // WHERE datetime <= 12
     * </code>
     *
    ...
    public function filterByDateTime($dateTime = null, $comparison = null)
    {
        if (is_array($dateTime)) {
            ...
            if (isset($dateTime['min'])) {
                $this->addUsingAlias(UserPeer::DATETIME, $dateTime['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($dateTime['max'])) {
                $this->addUsingAlias(UserPeer::DATETIME, $dateTime['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserPeer::DATETIME, $dateTime, $comparison);
    }
    ...
    public function filterByGroupId($groupId = null, $comparison = null)
    {
        if (is_array($groupId)) {
            ...
            if (isset($groupId['min'])) {
                $this->addUsingAlias(UserPeer::GROUPID, $groupId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($groupId['max'])) {
                $this->addUsingAlias(UserPeer::GROUPID, $groupId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserPeer::GROUPID, $groupId, $comparison);
    }
    ...
    public function filterByGroup($group, $comparison = null)
    {
        if ($group instanceof Group) {
            return $this
                ->addUsingAlias(UserPeer::GROUPID, $group->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserPeer::GROUPID, $group->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Triangulum\WebsiteBundle\Model\GroupQuery A secondary query class using the current class as primary query
     */
    public function useGroupQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinGroup($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Group', '\Triangulum\WebsiteBundle\Model\GroupQuery');
    }
