...
use Triangulum\WebsiteBundle\Model\map\GroupTableMap;
...
abstract class BaseGroupPeer
{
    ...
    const OM_CLASS = 'Triangulum\\WebsiteBundle\\Model\\Group';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ParentId', 'Name', 'Role', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'parentId', 'name', 'role', ),
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID, GroupPeer::PARENTID, GroupPeer::NAME, GroupPeer::ROLE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PARENTID', 'NAME', 'ROLE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'parentId', 'name', 'role', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ParentId' => 1, 'Name' => 2, 'Role' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'parentId' => 1, 'name' => 2, 'role' => 3, ),
        BasePeer::TYPE_COLNAME => array (GroupPeer::ID => 0, GroupPeer::PARENTID => 1, GroupPeer::NAME => 2, GroupPeer::ROLE => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PARENTID' => 1, 'NAME' => 2, 'ROLE' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'parentId' => 1, 'name' => 2, 'role' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupPeer::PARENTID);
            $criteria->addSelectColumn(GroupPeer::NAME);
            $criteria->addSelectColumn(GroupPeer::ROLE);
        } else {
