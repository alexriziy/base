...
use \PropelPDO;
use Triangulum\WebsiteBundle\Model\Group;
 ...
 * @method GroupQuery orderByParentId($order = Criteria::ASC) Order by the parentId column
 * @method GroupQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method GroupQuery orderByRole($order = Criteria::ASC) Order by the role column
 *
 * @method GroupQuery groupById() Group by the id column
 * @method GroupQuery groupByParentId() Group by the parentId column
 * @method GroupQuery groupByName() Group by the name column
 * @method GroupQuery groupByRole() Group by the role column
 *
 ...
 *
 * @method Group findOneByParentId(int $parentId) Return the first Group filtered by the parentId column
 * @method Group findOneByName(string $name) Return the first Group filtered by the name column
 * @method Group findOneByRole(string $role) Return the first Group filtered by the role column
 *
 * @method array findById(int $id) Return Group objects filtered by the id column
 * @method array findByParentId(int $parentId) Return Group objects filtered by the parentId column
 * @method array findByName(string $name) Return Group objects filtered by the name column
 * @method array findByRole(string $role) Return Group objects filtered by the role column
 */
abstract class BaseGroupQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Triangulum\\WebsiteBundle\\Model\\Group', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `parentId`, `name`, `role` FROM `group` WHERE `id` = :p0';
        try {
     ...
     * $query->filterByParentId(array('max' => 12)); // WHERE parentId <= 12
     * </code>
     *
    ...
    public function filterByParentId($parentId = null, $comparison = null)
    {
        if (is_array($parentId)) {
            ...
            if (isset($parentId['min'])) {
                $this->addUsingAlias(GroupPeer::PARENTID, $parentId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($parentId['max'])) {
                $this->addUsingAlias(GroupPeer::PARENTID, $parentId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(GroupPeer::PARENTID, $parentId, $comparison);
    }
    ...
    public function filterByRole($role = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(GroupPeer::ROLE, $role, $comparison);
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Triangulum\WebsiteBundle\Model\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'User', '\Triangulum\WebsiteBundle\Model\UserQuery');
    }
