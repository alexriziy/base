...
namespace Triangulum\WebsiteBundle\Model\om;
...
use \PropelException;
use \PropelPDO;
use Triangulum\WebsiteBundle\Model\GroupPeer;
use Triangulum\WebsiteBundle\Model\User;
use Triangulum\WebsiteBundle\Model\UserPeer;
use Triangulum\WebsiteBundle\Model\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'Triangulum\\WebsiteBundle\\Model\\User';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'DateTime', 'UserName', 'Password', 'Email', 'Phone', 'GroupId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'dateTime', 'userName', 'password', 'email', 'phone', 'groupId', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::DATETIME, UserPeer::USERNAME, UserPeer::PASSWORD, UserPeer::EMAIL, UserPeer::PHONE, UserPeer::GROUPID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATETIME', 'USERNAME', 'PASSWORD', 'EMAIL', 'PHONE', 'GROUPID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'datetime', 'username', 'password', 'email', 'phone', 'groupId', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'DateTime' => 1, 'UserName' => 2, 'Password' => 3, 'Email' => 4, 'Phone' => 5, 'GroupId' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'dateTime' => 1, 'userName' => 2, 'password' => 3, 'email' => 4, 'phone' => 5, 'groupId' => 6, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::DATETIME => 1, UserPeer::USERNAME => 2, UserPeer::PASSWORD => 3, UserPeer::EMAIL => 4, UserPeer::PHONE => 5, UserPeer::GROUPID => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATETIME' => 1, 'USERNAME' => 2, 'PASSWORD' => 3, 'EMAIL' => 4, 'PHONE' => 5, 'GROUPID' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'datetime' => 1, 'username' => 2, 'password' => 3, 'email' => 4, 'phone' => 5, 'groupId' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::DATETIME);
            ...
            $criteria->addSelectColumn(UserPeer::GROUPID);
        } else {
    ...
    public static function doCountJoinGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserPeer::GROUPID, GroupPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of User objects pre-filled with their Group objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to $obj2 (Group)
                $obj2->addUser($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to the collection in $obj2 (Group)
                $obj2->addUser($obj1);
